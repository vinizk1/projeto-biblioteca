...
<?php include("navbar.php") ?>
    <div class="header">
        <h1>Adicionar Cliente na Biblioteca do Urubu</h1>
    ...
    <div class="row mt-4">
        <div class="col-md-6 offset-3" style="text-align: center;">
            <form action="cliente.novo.post.php" method="POST">
                <div class="mb-3">
                    ...
                    <label for="nome" class="form-label" style="color: black;">Data de Nascimento</label>
