...
<head>
    ...
    <title>Editar Autor na Biblioteca do Urubu</title>
...
<?php include("navbar.php") ?>
    <div class="header">
        <h1>Editar Autor na Biblioteca do Urubu</h1>
    ...
    <div class="row mt-4">
        <div class="col-md-6 offset-3" style="text-align: center;">
            <form action="autor.editar.post.php" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">  
                    ...
                    <a href="autor.novo.php" class="btn btn-danger">Novo</a>
