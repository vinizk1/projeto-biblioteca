...
<body>
    ...
    <div class="header">
        <h1>Adicionar Devolucao na Biblioteca do Urubu</h1>
    ...
    <div class="row mt-4">
        <div class="col-md-6 offset-3" style="text-align: center;">
            <form action="emprestimo.efetuar.devolucao.php" method="POST">
                <div class="mb-3">
                    ...
                    <br>
                    <label for="nome" class="form-label" style="color: black;">Data de Vencimento</label>
                    <input type="text" class="form-control" name="data_vencimento" value="<?php echo $emprestimo->getDataVencimento('d/m/Y'); ?>" readonly>
                    <br>
                    <label for="nome" class="form-label" style="color: black;">Data Devolucao</label>
                    <input type="text" class="form-control" name="data_devolucao" value="<?php echo  date("d/m/Y"); ?>" readonly>
                    <br>
                    <label for="nome" class="form-label" style="color: black;">Multa</label>
                    <?php
                    $multa = 0;
                    if($emprestimo->getDataVencimento() < date("Y-m-d")){
                        ...
                        $multa = ($diff / (60*60*24)) * 1;
                    }
                    ?>
                    <input type="text" class="form-control" name="multa" value="<?php echo number_format($multa,2,",","."); ?>" readonly>
